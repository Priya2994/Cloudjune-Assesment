...
export const FORM_FIELDS = {
  STEP_1: ['name', 'nationalId', 'dateOfBirth', 'gender', 'address', 'city', 'state', 'country', 'phone', 'email'],
  STEP_2: ['maritalStatus', 'dependents', 'employmentStatus', 'monthlyIncome', 'housingStatus'],
  STEP_3: ['financialSituation', 'employmentCircumstances', 'reasonForApplying']
}
...
export const AI_PROMPTS = {
  financialSituation: "Write a professional, empathetic paragraph describing someone's current financial difficulties. Include details about unexpected expenses, income challenges, and the impact on basic needs. Keep it between 50-100 words and make it sound personal and genuine.",
  employmentCircumstances: "Write a professional paragraph describing someone's current employment situation who needs assistance. Include details about job stability, working hours, and efforts to improve their situation. Keep it between 50-100 words and make it sound authentic.",
  reasonForApplying: "Write a professional, compelling paragraph explaining why someone is applying for financial assistance. Include how the assistance will help them achieve stability and independence. Keep it between 50-100 words and make it sincere."
}

// Arabic prompts for AI content generation
export const AI_PROMPTS_AR = {
  financialSituation: "اكتب فقرة مهنية ومتعاطفة تصف الصعوبات المالية الحالية لشخص ما. تشمل التفاصيل حول النفقات غير المتوقعة وتحديات الدخل والتأثير على الاحتياجات الأساسية. اجعلها بين 50-100 كلمة واجعلها تبدو شخصية وحقيقية.",
  employmentCircumstances: "اكتب فقرة مهنية تصف الوضع الوظيفي الحالي لشخص يحتاج المساعدة. تشمل التفاصيل حول استقرار العمل وساعات العمل والجهود المبذولة لتحسين الوضع. اجعلها بين 50-100 كلمة واجعلها تبدو أصيلة.",
  reasonForApplying: "اكتب فقرة مهنية مقنعة تشرح لماذا يتقدم شخص ما للحصول على المساعدة المالية. تشمل كيف ستساعدهم المساعدة في تحقيق الاستقرار والاستقلالية. اجعلها بين 50-100 كلمة واجعلها صادقة."
}
...
export const ERROR_MESSAGES = {
  MISSING_API_KEY: 'OpenAI API key not found. Please set VITE_OPENAI_API_KEY in your .env file.',
